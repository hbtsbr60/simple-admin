const messagesInEnglish = {
  ...
  "error.phoneNumber.len": "Phone number should be 11 numbers long",
  "error.password.required": "Password should be 8 to 64 characters long",
  "error.password.min": "Password should be at least 8 characters long",
